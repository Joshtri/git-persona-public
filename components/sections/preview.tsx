    ...
    <Section id="preview">
      <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:gap-16">
        <SectionHeading
          ...
          title={
            <>
              Feel the <span className="text-gradient">switch</span>.
            </>
          }
          description="Click a profile. Everything updates — exactly like your machine would."
        />
        ...
        <Reveal className="relative">
          ...
          <div className="grid bg-surface sm:grid-cols-[220px_1fr]">
            ...
            <div className="relative min-h-[280px] p-5">
                ...
                {phase === "switching" ? (
                  ...
                  >
                    ...
                    <p className="font-mono text-[11px]">
                      Rewriting config · loading SSH key · swapping
                      credentials…
                    </p>
                  </motion.div>
                ) : (
                  ...
                  >
                    ...
                    <p className="text-center font-mono text-[10.5px] text-subtle">
                      {phase === "done"
                        ? "0.6s — no terminal, no config files."
              ...
              {/* Floating toast — overlays the panel instead of pushing it. */}
              <AnimatePresence>
                {phase === "done" && (
                  <motion.div
                    key="toast"
